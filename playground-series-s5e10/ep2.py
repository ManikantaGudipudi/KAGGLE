...
def preprocess_data(train_path='train.csv', test_path='test.csv', 
    ...
    #     preprocessor.save('preprocessor_xgb_myscore.pkl')
...
def train_xgboost_model(X_train, y_train, X_test_real, test_ids,
    ...
    submission_file = 'submission_xgboost_myscore_v2.csv'
    ...
    # model_file = 'xgboost_model_myscore.pkl'
...
if __name__ == "__main__":
    ...
    print(f"✓ Preprocessor saved to 'preprocessor_xgb.pkl'")
